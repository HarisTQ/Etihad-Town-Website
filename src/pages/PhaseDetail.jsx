...
export default function PhaseDetail() {
  ...
  return (
    <div className="relative min-h-screen pb-20 pt-24 md:pt-28">
      <div className="site-container relative z-10">
        ...
        {phase.available ? (
          <div className="flex flex-col gap-16 md:gap-20">
            ...
            <section>
              <SectionHeading index={4} tag="Immersive" title="360Â° Virtual Tour" />
              <VRFrame
                src={phase.vrTour}
          ...
          <div className="flex flex-col gap-12">
            {phase.paymentPlan && (
              <section>
                <SectionHeading index={1} tag="Investment" title="Payment Plan" />
                <ZoomableImage
                  src={phase.paymentPlan}
                  alt={`${phase.title} payment plan`}
                  onZoom={setZoom}
            ...
            {phase.mapEmbed && (
              <section>
                <SectionHeading index={phase.paymentPlan ? 2 : 1} tag="Find Us" title="Location Map" />
                <div className="card overflow-hidden rounded-3xl">
                  <iframe
                    src={phase.mapEmbed}
                    title={`Etihad Town ${phase.name} location map`}
            ...
            <div className="card flex flex-col items-center gap-5 rounded-3xl px-6 py-20 text-center">
              ...
              <p className="max-w-md text-body">
                ...
                map and 360Â° tour will be added here shortly.
              </p>
